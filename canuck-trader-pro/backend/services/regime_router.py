...
DEFAULT_REGIME_STRATEGIES: Dict[str, Dict[str, float]] = {
    ...
    "BREAKOUT": {
        "DONCHIAN": 1.5, "VOL_SQUEEZE": 1.6, "VOL_SPIKE": 1.4,
        "MOMENTUM_ROC": 1.3, "KELTNER": 1.1, "ENGULFING": 1.2,
        "SUPERTREND": 1.2, "MACD": 1.0, "OBV": 1.1,
    },
    "CRISIS": {
        "RSI": 1.3, "MEAN_REVERT": 1.2, "BOLLINGER": 1.1, "ENGULFING": 1.3,
...
TRANSITION_STRATEGIES: Dict[str, List[str]] = {
    "RANGE_BOUND->BREAKOUT": ["VOL_SQUEEZE", "DONCHIAN", "VOL_SPIKE"],
    ...
    "RANGE_BOUND->CRISIS": ["RSI", "ENGULFING", "STOCH_RSI"],
    "STRONG_TREND->CRISIS": ["RSI", "ENGULFING", "STOCH_RSI"],
    "CRISIS->WEAK_TREND": ["RSI", "MEAN_REVERT", "BOLLINGER", "ENGULFING"],
    "LOW_VOL_DRIFT->BREAKOUT": ["VOL_SQUEEZE", "DONCHIAN", "VOL_SPIKE"],
